        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KioskName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MacAddress = table.Column<string>(type: "varchar(50)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KioskIncidents", x => x.IncidentId);
                    table.ForeignKey(
                        name: "FK_KioskIncidents_Kiosks_KioskId",
                        column: x => x.KioskId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PromotionOrderDiscounts", x => x.PromotionId);
                    table.ForeignKey(
                        name: "FK_PromotionOrderDiscounts_Promotions_PromotionId",
            ...
            migrationBuilder.CreateTable(
                name: "PromotionProductDiscounts",
                columns: table => new
                {
                    PromotionId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PromotionProductDiscounts", x => new { x.PromotionId, x.BookId });
                    table.ForeignKey(
                        name: "FK_PromotionProductDiscounts_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "BookId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PromotionProductDiscounts_Promotions_PromotionId",
                        column: x => x.PromotionId,
                        principalTable: "Promotions",
                        principalColumn: "PromotionId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImportReceiptDetails", x => new { x.ImportReceiptId, x.BookId });
                    table.ForeignKey(
                        name: "FK_ImportReceiptDetails_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "BookId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TransactionId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderId = table.Column<int>(type: "int", nullable: false),
                    ReferenceCode = table.Column<string>(type: "varchar(50)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ImportReceiptDetails_BookId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KioskIncidents_KioskId",
                table: "KioskIncidents",
                column: "KioskId");

            migrationBuilder.CreateIndex(
                name: "IX_Kiosks_MacAddress",
                table: "Kiosks",
                column: "MacAddress",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PromotionProductDiscounts_BookId",
                table: "PromotionProductDiscounts",
                column: "BookId");
